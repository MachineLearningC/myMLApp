...
namespace MyMLAppML.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"D:\Noor\AI\myMLApp\wikipedia-detox-250-line-data.tsv";
        ...
        private static ModelInput CreateSingleDataSample(string dataFilePath)
        {
            ...
            ModelInput sampleForPrediction = mlContext.Data.CreateEnumerable<ModelInput>(dataView, false).ElementAt(rnd.Next(1, 200));
